...
public class NewProjectForm extends ModalForm {

    private final ProjectManager manager;
    public NewProjectForm (ProjectManager manager) {
    ...
    public VBox render() {
        ...
        rendered = new VBox(projectName, projectPath, plateNumberRows, plateNumberColumns);
        return rendered;
    }
